...
#==============================================================================
    ...
    if i>0:
        ...
        #print(end - start)
        if verbosity > 0:
            plot_velocity(model, pltname="model_marmousi2d-isotropic")
        ...
        model = demo_model('marmousi2d-isotropic', data_path="/media/pedrosp/Data/Simulations/devitocodes/data") 
        if verbosity > 0:
            plot_velocity(model, pltname="model_marmousi2d-isotropic")
...
#==============================================================================
    ...
    #print(field)
    np.save("model_marmousi2d-isotropic",field)
...
#==============================================================================
    np.save("rec_marmousi2d-isotropic",rec.data)
    if verbosity > 0:
        plot_shotrecord(rec.data, model, t0, tn, pltname="rec_marmousi2d-isotropic")
#==============================================================================